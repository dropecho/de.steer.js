var DE=DE||{};DE.Steer=DE.Steer||{};DE.Steer.Behaviors={};DE.Steer.Behaviors.Align=function(a,b){for(var c=DE.Math.Vec2d(),d=b.length,e=0;e<d;++e)c.Add(b[e]);0<d&&(c.Scale(1/d),c.Sub(a));return c};DE.Steer.Behaviors.Arrive=function(a,b,c,d){d=d||5;var e=a.DistanceFrom(b);return 0<e?(c=DE.Math.Clamp(e/d,0,c),this.Seek(a,b,c)):DE.Math.Vec2d(0,0)};
DE.Steer.Behaviors.Cohese=function(a,b,c){for(var d=DE.Math.Vec2d(0,0),e=b.length,f=0;f<e;f++)d.Add(b[f]);return 0<e?(d.Scale(1/e),this.Arrive(a,d,c)):DE.Math.Vec2d(0,0)};DE.Steer.Behaviors.Evade=function(a,b,c,d,e){var f=DE.Math.Vector.Sub(b,a);d=DE.Math.HeadingVec(targetHeadingDeg);e=e||60;c=f.Length()/(c+e);b=DE.Math.Vector.Add(b,d.Normalize(c));return this.Flee(a,b)};
DE.Steer.Behaviors.Flee=function(a,b,c,d){d=void 0===d||-1===d||b.DistanceFrom(a)<=d;a=DE.Math.Vector.Sub(a,b).Normalize(c);return d?a:DE.Math.Vec2d(0,0)};DE.Steer.Behaviors.Hide=function(){};DE.Steer.Behaviors.Interpose=function(a,b,c,d){b=DE.Math.Vector.MidPoint(b,c);return Arrive(a,b,d)};DE.Steer.Behaviors.ObstacleAvoid=function(){};
DE.Steer.Behaviors.Pursuit=function(a,b,c,d,e){var f=DE.Math.Vector.Sub(b,a);d=d instanceof DE.Math.Vector?d:DE.Math.HeadingVec(targetHeadingDEg);e=e||60;c=f.Length()/(c+e);b=DE.Math.Vector.Add(b,d.Normalize(c));return this.Seek(a,b)};DE.Steer.Behaviors.Seek=function(a,b,c){return DE.Math.Vector.Sub(b,a).Normalize(c)};DE.Steer.Behaviors.Seperation=function(a,b){for(var c=DE.Math.Vec2d(0,0),d=b.length,e=0;e<d;e++){var f=DE.Math.Vector.Sub(a,b[e]),g=f.Length();c.Add(f.Normalize(128/g))}return c};
DE.Steer.Behaviors.Wander=function(a,b,c){var d=DE.Math.Rand(-1,1),e=DE.Math.Rand(-1,1),d=DE.Math.Vec2d(d,e).Normalize();b.Add(d).Normalize(1);b=DE.Math.Vector.Add(b,DE.Math.Vec2d(10,0));c=DE.Math.Vector.LocalToWorld(b,c,a);return this.Seek(a,c,1)};DE=DE||{};DE.Steer=DE.Steer||{};DE.Steer.EntityBehaviors=function(){return function(a){this.entity=a;this.DE_wanDEr_target=DE.Math.Vec2d()}}();DE.Steer.EntityBehaviors.prototype.ToLocal=function(a){return DE.Math.Vector.WorldToLocal(a,this.entity.DE_heading())};DE.Steer.EntityBehaviors.prototype.Align=function(){};DE.Steer.EntityBehaviors.prototype.Arrive=function(a,b){var c=this.entity.DE_pos(),d=a.DE_pos(),e=this.entity.DE_max_speed();return DE.Steer.Behaviors.Arrive(c,d,e,b)};
